...
namespace WebApplicatin.Infrastructure.Implementations
{
    ...
    {
        //конструктор принимает товары и сервис
        ...
        public void AddToCart(int id)
        {
            ...
            if (item != null)
                ...
                //если его нет - добавить в корзину
        ...
        {
            //не можем обращаться напрямую к Cart, поэтому сначала получим item в переменную и отработаем
            var cart = Cart;
